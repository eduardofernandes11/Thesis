...
% falar de algumas técnicas de nlp
The \ac{nlp} field is vast and has a wide array of techniques, each contributing uniquely to the understanding and processing of language. Some of the techniques that form the basis of many \ac{nlp} tasks include tokenization, normalization, stemming, the use of stop words, the application of regular expressions, similarity measures, and both syntactic and semantic analysis.
